...
import { Download, Eye, Mic, Upload, StopCircle } from "lucide-react"
            ...
            {result && (
              <div className="space-y-6">
                ...
                {plotPath && (
                  <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <div className="border-b border-gray-200 dark:border-gray-700 px-6 py-4 bg-gray-50 dark:bg-gray-800">
                      <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Visual Analysis</h2>
                    </div>
                    <div className="p-6">
                      <img
                        src={API_ENDPOINTS.PLOT(plotPath)}
                        alt="Voice Analysis Plot"
                  ...
                  <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div className="p-6">
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                        Your comprehensive voice analysis report is ready to view or download.
                      </p>
                      <div className="flex flex-col sm:flex-row gap-3">
                        <button
                          onClick={viewReport}
                          className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors font-medium"
                        >
                        ...
                        <button
                          ...
                          className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-white dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors font-medium"
                        >
