    ...
    <ProtectedRoute>
      <Layout>
        <div className="container py-8 flex flex-col items-center justify-center">
          <h1 className="text-4xl font-bold mb-6 text-center">Talk to VocalWell AI</h1>
          ...
          <div className="text-center text-gray-600 max-w-lg">
            <p className="mb-4">Use the voice chat button on the left or text chat on the right to interact with VocalWell AI.</p>
