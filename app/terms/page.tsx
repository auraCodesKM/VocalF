        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="space-y-6">
            <section className="space-y-3">
              ...
              <p>
                Welcome to Echo.ai. These Terms and Conditions govern your use of our website and services. 
                By accessing or using Echo.ai, you agree to be bound by these Terms. If you disagree with any part of the terms, 
            ...
            <section className="space-y-3">
              ...
              <p>
                Echo.ai provides an AI-powered voice analysis tool designed to help detect potential voice disorders. 
            ...
            <section className="space-y-3">
              ...
              <p>
                ...
                By using Echo.ai, you agree to the collection and use of information in accordance with our Privacy Policy.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                In no event shall Echo.ai, its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, 
