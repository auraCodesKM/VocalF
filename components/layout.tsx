...
import { Mic, Moon, Sun, Menu, X, LogOut, User, ChevronDown, Volume2 } from "lucide-react"
import { Button } from "@/components/ui/button"
import { useTheme } from "next-themes"
import { useAuth } from "@/lib/auth-context"
import { logOut } from "@/lib/firebase"
import { useRouter } from "next/navigation"
import { ChatbotsManager } from "@/components/chatbots"
    ...
    <div className="flex min-h-screen flex-col">
      ...
      >
        <div className="container flex h-24 items-center justify-between">
          ...
          {/* Desktop Navigation */}
          <nav className="hidden lg:flex items-center space-x-10 text-sm font-medium z-10">
            ...
            <Button
              ...
              className="text-base rounded-full w-12 h-12 bg-gray-100 dark:bg-gray-800"
            >
          ...
          <div className="lg:hidden flex items-center z-10">
            <Button
              ...
              className="rounded-full w-12 h-12 bg-gray-100 dark:bg-gray-800"
            >
              {mobileMenuOpen ? (
                <X className="h-5 w-5" />
              ) : (
      ...
      {/* Add ChatbotsManager to load both chatbots on every page */}
      <ChatbotsManager />
    </div>
  )
}
